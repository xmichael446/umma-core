...
export const MsgCreateDenom = {
  encode(message: MsgCreateDenom, writer: Writer = Writer.create()): Writer {
    ...
    if (message.siteUrl !== "") {
      writer.uint32(50).string(message.siteUrl);
    }
    if (message.logoUrl !== "") {
      writer.uint32(58).string(message.logoUrl);
    }
    if (message.maxSupply !== 0) {
      writer.uint32(64).int32(message.maxSupply);
    }
  ...
  fromJSON(object: any): MsgCreateDenom {
    ...
    if (object.siteUrl !== undefined && object.siteUrl !== null) {
  ...
  toJSON(message: MsgCreateDenom): unknown {
    ...
    message.siteUrl !== undefined && (obj.siteUrl = message.siteUrl);
...
export const MsgUpdateDenom = {
  encode(message: MsgUpdateDenom, writer: Writer = Writer.create()): Writer {
    ...
    if (message.siteUrl !== "") {
      writer.uint32(34).string(message.siteUrl);
    }
    if (message.logoUrl !== "") {
...
const baseMsgBurnTokens: object = { owner: "", denom: "", amount: 0 };

export const MsgBurnTokens = {
  encode(message: MsgBurnTokens, writer: Writer = Writer.create()): Writer {
    if (message.owner !== "") {
      writer.uint32(10).string(message.owner);
    }
    if (message.denom !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgBurnTokens {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgBurnTokensResponse = {
  encode(_: MsgBurnTokensResponse, writer: Writer = Writer.create()): Writer {
    return writer;
  },

  decode(input: Reader | Uint8Array, length?: number): MsgBurnTokensResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgClientImpl implements Msg {
  ...
  CreateDenom(request: MsgCreateDenom): Promise<MsgCreateDenomResponse> {
    ...
    const promise = this.rpc.request(
      "ummachain.ummacore.factory.Msg",
      "CreateDenom",
      data
    );
  ...
  BurnTokens(request: MsgBurnTokens): Promise<MsgBurnTokensResponse> {
    ...
    return promise.then((data) =>
      MsgBurnTokensResponse.decode(new Reader(data))
    );
  }
}
