import { Client, registry, MissingWalletError } from 'juno-v11-client-ts'

import { Params } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorHistoricalRewards } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorCurrentRewards } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorAccumulatedCommission } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorOutstandingRewards } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorSlashEvent } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorSlashEvents } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { FeePool } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { CommunityPoolSpendProposal } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { DelegatorStartingInfo } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { DelegationDelegatorReward } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { CommunityPoolSpendProposalWithDeposit } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { DelegatorWithdrawInfo } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorOutstandingRewardsRecord } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorAccumulatedCommissionRecord } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorHistoricalRewardsRecord } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorCurrentRewardsRecord } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { DelegatorStartingInfoRecord } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
import { ValidatorSlashEventRecord } from "juno-v11-client-ts/cosmos.distribution.v1beta1/types"
