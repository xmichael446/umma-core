...
func init() {
	proto.RegisterType((*QueryConfigRequest)(nil), "ummachain.ummacore.configuration.v1beta1.QueryConfigRequest")
	proto.RegisterType((*QueryConfigResponse)(nil), "ummachain.ummacore.configuration.v1beta1.QueryConfigResponse")
	proto.RegisterType((*QueryFeesRequest)(nil), "ummachain.ummacore.configuration.v1beta1.QueryFeesRequest")
	proto.RegisterType((*QueryFeesResponse)(nil), "ummachain.ummacore.configuration.v1beta1.QueryFeesResponse")
}
...
func (c *queryClient) Config(ctx context.Context, in *QueryConfigRequest, opts ...grpc.CallOption) (*QueryConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ummachain.ummacore.configuration.v1beta1.Query/Config", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Fees(ctx context.Context, in *QueryFeesRequest, opts ...grpc.CallOption) (*QueryFeesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ummachain.ummacore.configuration.v1beta1.Query/Fees", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Config_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ummachain.ummacore.configuration.v1beta1.Query/Config",
	}
...
func _Query_Fees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ummachain.ummacore.configuration.v1beta1.Query/Fees",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ummachain.ummacore.configuration.v1beta1.Query",
