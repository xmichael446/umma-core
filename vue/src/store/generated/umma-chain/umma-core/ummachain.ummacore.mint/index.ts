...
import { Minter } from "./module/types/umma/mint/mint"
import { Params } from "./module/types/umma/mint/mint"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: ummachain.ummacore.mint initialized!')
