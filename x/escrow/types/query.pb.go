...
func init() {
	proto.RegisterType((*QueryEscrowRequest)(nil), "ummachain.ummacore.escrow.v1beta1.QueryEscrowRequest")
	proto.RegisterType((*QueryEscrowResponse)(nil), "ummachain.ummacore.escrow.v1beta1.QueryEscrowResponse")
	proto.RegisterType((*QueryEscrowsRequest)(nil), "ummachain.ummacore.escrow.v1beta1.QueryEscrowsRequest")
	proto.RegisterType((*QueryEscrowsResponse)(nil), "ummachain.ummacore.escrow.v1beta1.QueryEscrowsResponse")
}
...
func (c *queryClient) Escrow(ctx context.Context, in *QueryEscrowRequest, opts ...grpc.CallOption) (*QueryEscrowResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ummachain.ummacore.escrow.v1beta1.Query/Escrow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Escrows(ctx context.Context, in *QueryEscrowsRequest, opts ...grpc.CallOption) (*QueryEscrowsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ummachain.ummacore.escrow.v1beta1.Query/Escrows", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Escrow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ummachain.ummacore.escrow.v1beta1.Query/Escrow",
	}
...
func _Query_Escrows_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ummachain.ummacore.escrow.v1beta1.Query/Escrows",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ummachain.ummacore.escrow.v1beta1.Query",
