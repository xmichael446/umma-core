...
// any overrides above
var (
	// DefaultNodeHome default home directories for Umma
...
func GetWasmOpts(appOpts servertypes.AppOptions) []wasm.Option {
	...
	wasmOpts = append(wasmOpts, wasmkeeper.WithGasRegister(NewUmmaWasmGasRegister()))
...
// New returns a reference to an initialized Umma.
func New(
	logger log.Logger,
	db dbm.DB,
...
// AppCodec returns Umma's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns Umma's InterfaceRegistry
